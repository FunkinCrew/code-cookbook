...
Sometimes when creating a module you might require a more specialized approach: Only firing events when you are in a certain state. A scoped module is the right tool.
