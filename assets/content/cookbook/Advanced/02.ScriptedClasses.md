...
- `funkin.group.FunkinSpriteGroup` for groups of sprites which are included inside a state and manipulated together. Similar to `FlxSpriteGroup`, but adds improved functionality for group modification actions.
