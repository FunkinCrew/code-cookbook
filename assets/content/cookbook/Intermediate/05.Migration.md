...
The class used to make texture atlas sprites has moved from `FlxAtlasSprite` to `FunkinSprite`. An import alias was kept for backwards compatability, however.
